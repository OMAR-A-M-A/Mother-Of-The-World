...
// Go back 2 levels (admin/governorates/ -> root)
include '../../config.php';
    ...
    <div class="d-flex">
        ...
        <div class="flex-grow-1 bg-light">
            ...
            <div class="container-fluid p-4">
                ...
                <div class="mb-4">
                    <a href="manage_gov.php" class="btn btn-secondary">
                            ...
                            <div class="card-body">
                                ...
                                <form action="gov_functions.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        <div class="row align-items-center">
                                            <div class="col-md-4 text-center mb-3 mb-md-0">
                                                ...
                                                <?php
                                                // Construct Image Path using BASE_URL for display
                                                $img_src = BASE_URL . "assets/uploads/governorates/" . $row['image_url'];
                                                ?>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <small class="text-muted d-block mt-1">Leave empty if you don't want to
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" name="update_gov_btn" class="btn btn-primary px-4">
                                            Update Data
                                        </button>
                                    </div>
