...
// 1. استقبال ID المكان والتحقق منه
$place_id = isset($_GET['id']) ? intval($_GET['id']) : 0;

// if ($place_id == 0) {
//     // لو مفيش ID، رجعه للصفحة الرئيسية
//     header("Location: index.php");
//     exit();
// }

// 2. جلب تفاصيل المكان الأساسية
$place = null;
...
// 3. جلب صور الجاليري من جدول place_images
$gallery_images = [];
...
<head>
    ...
    <style>
        /* تخصيصات خاصة لصفحة التفاصيل تتماشى مع الثيم */
...
<body>
    ...
    <div class="details-hero" style="background-image: url('<?php echo !empty($main_image_path) ? $main_image_path : 'assets/images/default-place.jpg'; ?>');">
        <div class="container">
            <div class="hero-content">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <span class="info-badge">
                        <i class="fas fa-map-marker-alt"></i> <?php echo htmlspecialchars($place['governorate_name']); ?>
                    </span>
                    <?php endif; ?>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="mb-5">
                    ...
                    <p class="lead" style="line-height: 1.8; color: var(--text-body);">
                ...
                <div class="mb-5">
                    ...
                    <div class="gallery-grid">
                        <?php foreach($gallery_images as $img): 
                            $img_path = '';
                            // التحقق من مسار الصورة (رابط خارجي أو ملف محلي)
                            if (filter_var($img, FILTER_VALIDATE_URL)) {
                                $img_path = $img;
                            } elseif (file_exists(dirname(__FILE__) . '/assets/uploads/places/' . $img)) {
                                // افترضنا أن صور الجاليري في نفس مسار صور الأماكن، عدلها لو في فولدر تاني
                ...
                <?php endif; ?>
             <iframe src="<?php echo htmlspecialchars($place['location_url']); ?>" width="860"  loading="lazy" referrerpolicy="no-referrer-when-downgrade" height="400" class="rounded"></iframe>
            </div>
            <div class="col-lg-4">
                ...
                <div class="info-card sticky-top" style="top: 100px;">
                    ...
                    <div class="info-details">
                        <h5 class="mb-3 text-uppercase" style="color: var(--logo-dark); letter-spacing: 1px;">Information</h5>
                        ...
                        <div class="mt-4">
                            <a href="<?php echo htmlspecialchars($place['location_url']); ?>" target="_blank" class="btn btn-primary w-100" style="background-color: var(--action-button); border: none; padding: 12px;">
